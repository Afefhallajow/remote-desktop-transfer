...
import project.facade.Services_Map;
...
public class Socket_Sender extends Sender {
    ...
    @Override
    public ServiceMessage send_request(Request request) throws IOException, ClassNotFoundException, InvalidKeySpecException, NoSuchAlgorithmException {
        ...
        if(request.getObjects().getClass().equals(String.class)){
            ...
            System.out.println("service now : "+executed_service);
            json.put("sended","1");
