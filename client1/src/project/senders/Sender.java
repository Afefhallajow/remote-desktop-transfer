...
public abstract class Sender {
    ...
    abstract public ServiceMessage send_request(Request request) throws IOException, ClassNotFoundException, InvalidKeySpecException, NoSuchAlgorithmException;
