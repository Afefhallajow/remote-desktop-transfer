...
public class test {
    ...
    public static void main(String[] args) throws FtpException, InterruptedException, InvalidKeySpecException, NoSuchAlgorithmException, IOException, AWTException, ClassNotFoundException {
/*
