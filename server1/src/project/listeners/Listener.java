...
public abstract class Listener implements Runnable{
    ...
    protected Message transform_message(Request request) throws IOException {
    ...
    protected ServiceMessage call_facade(Message msg) throws IOException, ClassNotFoundException, SQLException, NoSuchAlgorithmException, InvalidKeySpecException, ParseException, JOSEException {
    ...
    abstract public void fill_listen_information() throws IOException, FtpException;
